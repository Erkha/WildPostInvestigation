...
INSERT INTO `articles` VALUES (3,'Une étude montre que dormir nu met tout le dortoir mal à l’aise',
	...
	l’entièreté du dortoir mal à l’aise.</strong></p><p><em>« Les résultats sont clairs et nets. Nous avons 
	...
	presque impossible de dormir nu sans créer une sensation de gêne globale dans le dortoir. Cette sensation augmente
	 ...
	 pénis non-circoncis.</p><p>Nombreux sont en France les gens qui ont eu de mauvaises expériences en
	  ...
	  depuis qu’il s’est retrouvé dans la même chambre d’auberge de jeunesse qu’un voyageur sans pudeur.
	   ...
	   entièrement nu dans leur lit.</p><p>Qui plus est, la moitié des gens qui dorment nus affirment 
	   ressentir une sensation de manque car ils ne peuvent pas porter leur pyjama préféré.</p>','',
	   2,1,'assets/images/image0068647001556542475.jpeg'),(4,'Parti au Népal pour un voyage d’introspection, 
	   il se rend enfin compte qu’il est un connard',
	   '2019-04-29',2,1,'<p>
	   <strong>Sakhuwanankarkatti, Népal – Un Français de 27 ans parti dans ce pays enclavé de l’Himalaya pour
	    ...
	    </p><p>Gauthier, qui gagne sa vie en demandant aux gens dans la rue de donner de l’argent 
	    à une association, est encore sous le choc après avoir découvert les résultats de son voyage d’introspection.
	     ...
	     en une semaine de voyage. <em>“Je m’attendais juste à trouver la paix intérieure ou un truc bouddhiste
	      ...
	      en question.”</em></p><p><em>“J’ai supprimé une photo de moi avec un enfant de la rue sur Instagram 
	      ...
	      années.</p><p><em>“Je me rends compte que si mes relations amoureuses n’ont pas fonctionné, c’est
	       parce que je ne sais pas communiquer, et je compte me faire pardonner”</em>, avoue-t-il avant d’insulter 
	       une de ses ex-compagnes derrière son dos.</p><p><em>“Au moins, cette révélation aura fait de moi
	        ...
	        strip-tease employant probablement des adolescentes.</p><p>Une erreur commise à la publication de 
	        l’article a été corrigée. Le nom du village est Sakhuwanankarkatti, et non pas Sakhuwanakarkati.</p>',
	        '',2,1,'assets/images/image0678171001556542484.jpeg'),(5,'Malgré les avertissements, il court à la piscine
	         : 86 morts','2019-04-29',2,1,'<p><strong>Villejuif – Ce mardi, 
	         un individu au bord d’une piscine se serait mis à courir malgré l’interdiction et aurait ainsi provoqué 
	         la mort de 86 personnes.</strong></p><p> Le coureur fou aurait percuté plusieurs personnes
...
insert into authors values (2,'CORTES','Nathalie','Nath','4a8abe5d23109378be454abab48edc43',NULL);
